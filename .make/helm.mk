...
HELM_YQ_VERSION ?= 4.35.1## yq version to install
...
helm-install-yq:
	...
	if [ "`yq --version | awk '{print $$4}'`" != v"$(HELM_YQ_VERSION)" ]; then \
		...
		echo "helm-install-yq: yq version $(HELM_YQ_VERSION) already installed"; \
	fi
