...
def mid_osd_data_for_cycle_id_1():
    return {'capabilities': {'mid': {'AA2': {'available_bandwidth_hz': 800000000.0,
                          ...
                          'basic_capabilities': {'dish_elevation_limit_deg': 15.0,
                                                 'receiver_information': [{'max_frequency_hz': 1050000000.0,
                                                                           'min_frequency_hz': 350000000.0,
                                                                           'rx_id': 'Band_1'},
                                                                          {'max_frequency_hz': 1760000000.0,
                                                                           'min_frequency_hz': 950000000.0,
                                                                          ...
                                                                          {'max_frequency_hz': 15400000000.0,
                                                                           'min_frequency_hz': 8300000000.0,
                                                                           'rx_id': 'Band_5b'}]}}},
 'observatory_policy': {'cycle_description': 'Science Verification',
                        'cycle_information': {'cycle_id': 'SKAO_2027_1',
...
@pytest.fixture
def mid_osd_data_for_array_assembly_AA05():
    return {'capabilities': {'mid': {'AA0.5': {'available_bandwidth_hz': 800000000.0,
                                    'available_receivers': ['Band_1', 'Band_2'],
                                    'cbf_modes': ['CORR'],
                                    'max_baseline_km': 1.5,
                                    'number_channels': 14880,
...
def mid_osd_data_for():
    return {'capabilities': {'mid': {'AA0.5': {'available_bandwidth_hz': 800000000.0,
                                    ...
                                    'number_zoom_windows': 0,
                                    'ps_beam_bandwidth_hz': 0.0},
                          'AA1': {'available_bandwidth_hz': 800000000.0,
                                  'available_receivers': ['Band_1',
                                                          'Band_2',
                                                          'Band_5a',
                                                          'Band_5b'],
                                  'cbf_modes': ['CORR', 'PST_BF'],
                                  'max_baseline_km': 1.5,
                                  'number_channels': 14880,
                                  'number_fsps': 4,
                                  'number_meerkat_dishes': 0,
                          ...
                          'AA2': {'available_bandwidth_hz': 800000000.0,
                                  'available_receivers': ['Band_1',
                                                          'Band_2',
                                                          'Band_5a',
                                                          'Band_5b'],
