...
from ska_ost_osd.rest.api.resources import update_osd_data


class TestResources:
    @pytest.fixture
    def mock_read_file(self):
        with patch("ska_ost_osd.rest.api.resources.read_file") as mock:
            mock.return_value = {
                "cycle_number": 1,
    ...
    def test_update_osd_data_invalid_array_assembly(self, mock_read_file):
        """
        Test update_osd_data when array_assembly is invalid for the current cycle
        """
