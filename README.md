Observatory Static Data Services
================================

The Observatory Static Data Services is the server component of the
Observatory Support Tools. It consists of a set of science domain configuration files that are required by the OST tools. 
...
The Swagger UI should be available external to the cluster at `http://<KUBE_HOST>/<KUBE_NAMESPACE>/osd/api/v1/ui/` and the API accesible via the same URL.
