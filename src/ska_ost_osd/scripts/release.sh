...
observatory_file_location="tmdata/observatory_policies.json"
version_mapping_file_location="tmdata/version_mapping/cycle_gitlab_release_version_mapping.json"
